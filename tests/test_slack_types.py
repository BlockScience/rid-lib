...
def test_slack_channel():
    channel1 = RID.from_string("orn:slack.workspace:TA2E6KPK3/C07BKQX0EVC")
...
def test_slack_message():
    ...
    assert message1.ts == message2.t == message3.ts == "1721669683.087619"
...
def test_slack_user():
    ...
    assert user1.user_id == user2.user_id == user3.user_id == "C07BKQX0EVC"
