...
def test_uri_rid_string():
    rid_string = "https://github.com/DynamicalSystemsGroup/rid-lib/"
    ...
    assert rid_obj.reference == "//github.com/DynamicalSystemsGroup/rid-lib/"
...
def test_rid_inequality():
    rid_obj = RID.from_string("https://github.com/DynamicalSystemsGroup/rid-lib/")
